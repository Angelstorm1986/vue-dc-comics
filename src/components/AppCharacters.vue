<template>
    <main>
        <div class="jumbotron">
            <img src="../assets/images/jumbotron.jpg" alt="Characters DC">
        </div>
        <div class="core">
            <button>Current Series</button>
            <div class="container">
                <div class="boxes">
                    <CharactersCard v-for="(card, index) in characters" :key="index" :thumb="card.thumb" :price="card.price" :series="card.series" :type="card.type"/>
                </div>
